...
<div class="button-wrapper" >
    ...
    <input type="submit" class="btn btn-primary" value="${content.buttonText!i18n['form.submit.default']?html}" />
    ...
    [#if backButtonText?has_content]
        ...
        <input type="submit" class="btn btn-light" onclick="return mgnlFormHandleBackButton(this)" value="${backButtonText}" />
    [/#if]
    ...
    [#if cancelButtonText?has_content]
        ...
        <input type="submit" class="btn btn-light" onclick="return mgnlFormReset(this)" value="${cancelButtonText}"/>
    [/#if]
